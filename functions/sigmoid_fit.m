function [param, stat]= sigmoid_fit (x, y, fixed_params, initial_params, plot_flag)
...
for i=1:4
    ...
    if i==2
        if isnan(fixed_params(1))            
            f_str=[f_str '-param(1) )./ (   1 + (2.7182818284).^( (']; 
        else
            f_str=[f_str '-' num2str(fixed_params(1)) ')./ (1 + (2.7182818284).^((']; 
        end
    end    
